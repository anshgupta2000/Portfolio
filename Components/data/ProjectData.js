...
export const Data = {
  "Recession Predictor USA (Python)": {
    description: `
    A predictor using 6 factors (employment rate, inflation, etc.) to predict a recession in USA
    ...
    githubLink: "https://github.com/anshgupta2000/Recession-Predictor-",
  },
  "Prediction of Parkinson’s Disease Using Biomarkers (R)": {
    ...
    `,
    githubLink:
      "https://github.com/anshgupta2000/Parkinson-s-Biomarker-Project",
  },
  "MIT Article/Patent Equity Data Analysis (Collaboration with Boston University School of Law) ":
    {
      description: `Purpose: To show if there exists a correlation between the articles published and patents issued by MIT professors and the race, gender and tenure status, and department of the respective professors.
  ...
  "Study Buddy App": {
    description: `Created a mobile app that allows students to find their classmates and create study groups with their fellow peers based on similar classes, majors, colleges, etc. Students can also purchase tutoring sessions and study guides from other students using the app.
  ...
  "ExcelLearn — built at BostonHacks 2019, Boston, MA": {
    description: `Created a specialized search engine for educational resources. It ranks the courses/content based on various factors such as user reviews, ratings, number of ratings, and it also provides many filters so the user can tailor courses as per their particular needs.
  ...
  "HiMedScan— built at Hashathon 6.0 Hackathon at HashedIn Technologies, Bengaluru, India":
    {
      description: `Created an application called HiMedScan that can diagnose pneumonia by looking at the patient’s X-Ray with 99% accuracy. 
