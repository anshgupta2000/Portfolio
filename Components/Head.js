      ...
      <div className="flex justify-center relative">
        <div className="invisible lg:visible absolute left-44">
          ...
          <div className="-ml-2 my-5 ">
            <a
              href="https://twitter.com/AnshGupta610"
              target="_blank"
              rel="noreferrer"
            >
              <FiTwitter size={25} />
            ...
            <br />
            <a
              href="https://www.linkedin.com/in/ansh-gupta-bucs/"
              target="_blank"
              rel="noreferrer"
            >
              <FiLinkedin size={25} />
            ...
            <br />
            <a
              href="https://www.instagram.com/anshgupta610/"
              target="_blank"
              rel="noreferrer"
            >
              <FiInstagram size={25} />
            ...
            <br />
            <a
              href="https://github.com/anshgupta2000/"
              target="_blank"
              rel="noreferrer"
            >
              <FiGithub size={25} />
